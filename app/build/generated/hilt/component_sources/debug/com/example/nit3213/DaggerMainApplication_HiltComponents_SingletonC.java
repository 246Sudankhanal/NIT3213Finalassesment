...
import com.example.nit3213.di.NetworkModule_ProvideApiServiceFactory;
import com.example.nit3213.di.NetworkModule_ProvideRetrofitFactory;
import com.example.nit3213.ui.dashboard.DashboardActivity;
import com.example.nit3213.ui.dashboard.DashboardViewModel;
import com.example.nit3213.ui.dashboard.DashboardViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.nit3213.ui.login.LoginActivity;
import com.example.nit3213.ui.login.LoginViewModel;
import com.example.nit3213.ui.login.LoginViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MainApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(DashboardViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(LoginViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put("com.example.nit3213.ui.dashboard.DashboardViewModel", ((Provider) dashboardViewModelProvider)).put("com.example.nit3213.ui.login.LoginViewModel", ((Provider) loginViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.nit3213.ui.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel(viewModelCImpl.authRepository());

          case 1: // com.example.nit3213.ui.login.LoginViewModel 
  ...
  private static final class SingletonCImpl extends MainApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.nit3213.data.api.ApiService 
