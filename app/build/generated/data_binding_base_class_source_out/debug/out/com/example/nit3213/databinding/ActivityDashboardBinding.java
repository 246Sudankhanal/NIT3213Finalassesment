...
public final class ActivityDashboardBinding implements ViewBinding {
  ...
  private ActivityDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvEntities) {
    this.rootView = rootView;
    this.progressBar = progressBar;
    this.rvEntities = rvEntities;
  }
  ...
  public static ActivityDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvEntities;
      RecyclerView rvEntities = ViewBindings.findChildViewById(rootView, id);
      if (rvEntities == null) {
        break missingId;
      }

      return new ActivityDashboardBinding((ConstraintLayout) rootView, progressBar, rvEntities);
    }
